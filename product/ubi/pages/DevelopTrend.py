...
class DevelopTrend(UbiCommon):
    ...
    def check_compare_detail_click(self,list_ind_info,rankingTypeId,verNo,compareVerNo):
        ...
        for dict_ind_info in list_ind_info:
            ...
            indValId,indDetailDefId = self.do.get_value_from_dict(dict_ind_indVal, 'indValId','indDetailDefId')
            ...
            indValIdComp,indDetailDefIdComp = self.do.get_value_from_dict(dict_ind_indValComp, 'indValId','indDetailDefId')
