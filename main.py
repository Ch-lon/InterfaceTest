...
test_url = "https://ubi-3f3ab907.gaojidata.com/login?loginTypeId=2&univCode={univCode}&loginName=&token={token}"
...
response = requests.post(cg_url, data={"LoginName": "", "Password": ""})
print(response.json())
...
headers = {
    ...
    "Referer": "https://ubi-3f3ab907.gaojidata.com/login?loginTypeId=2&univCode=RC00119&loginName=",
